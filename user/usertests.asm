...
copyinstr2(char *s)
{
  ...
  if(pid == 0){
    ...
    for(int i = 0; i < PGSIZE; i++)
     ...
     61e:	4fe70713          	addi	a4,a4,1278 # fb18 <big.1273>
    ...
    big[PGSIZE] = '\0';
     ...
     64c:	4d070713          	addi	a4,a4,1232 # fb18 <big.1273>
     650:	6785                	lui	a5,0x1
...
bigargtest(char *s)
{
  ...
  if(pid == 0){
    ...
    5ea4:	c8070713          	addi	a4,a4,-896 # 10b20 <args.1862>
    ...
    5ed6:	c4e78793          	addi	a5,a5,-946 # 10b20 <args.1862>
    5eda:	0e07bc23          	sd	zero,248(a5)
    exec("echo", args);
    5ede:	0000b597          	auipc	a1,0xb
    5ee2:	c4258593          	addi	a1,a1,-958 # 10b20 <args.1862>
