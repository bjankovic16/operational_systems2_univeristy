...
main(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     378:	a5450513          	addi	a0,a0,-1452 # 1dc8 <buf.1136>
     ...
     390:	a3c70713          	addi	a4,a4,-1476 # 1dc8 <buf.1136>
     ...
     3a2:	a2d78793          	addi	a5,a5,-1491 # 1dcb <buf.1136+0x3>
     3a6:	853e                	mv	a0,a5
     ...
     3ba:	a1578793          	addi	a5,a5,-1515 # 1dcb <buf.1136+0x3>
     3be:	863e                	mv	a2,a5
    ...
    if(fork1() == 0)
     ...
     3e4:	9e850513          	addi	a0,a0,-1560 # 1dc8 <buf.1136>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     40e:	9be50513          	addi	a0,a0,-1602 # 1dc8 <buf.1136>
